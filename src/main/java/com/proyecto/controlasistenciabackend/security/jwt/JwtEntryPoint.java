...
//CLASE QUE SE EJECUTA CUANDO EL USUARIO NO ESTÁ AUTENTICADO O NO ESTA AUTORIZADO PARA ACCEDER A UN RECURSO
@Component
public class JwtEntryPoint implements AuthenticationEntryPoint {

    private final static Logger logger = LoggerFactory.getLogger(JwtEntryPoint.class);
    private final static String ERROR_MESSAGE = "Unauthorized";
